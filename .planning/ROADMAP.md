...
- [ ] **Phase 1: Foundation** - Math engine, TypeScript types, Zustand store, and Vitest test suite — no UI, all correctness
- [ ] **Phase 2: Data Entry** - People, items, and assignment panels — fully working bill input on mobile
